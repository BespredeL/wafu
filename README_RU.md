...
'pipeline' => [
    ...
    // Проверки по паттернам
    'path_traversal',
    'lfi',
    'rce',

    // Regex проверки по паттернам
    'sql_injection',
    'xss',

    // Ресурсоемкие проверки последними
    'bad_bots',
    'rate_limit',
    'not_found_abuse',
],
...
'actions' => [
    'block' => [
        ...
        'terminate' => false, // включайте true только для standalone-скриптов с немедленным завершением
    ],
